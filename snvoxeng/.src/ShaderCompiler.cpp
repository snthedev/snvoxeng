...
ShaderCompiler::_Impl::_Impl() = default;
ShaderCompiler::_Impl::~_Impl() noexcept = default;
...
ShaderCompiler::shader_t ShaderCompiler::_Impl::loadFromFile(const char* filepath, bool forceCompile)
{
    ...
    shaderc::CompileOptions compilerOptions;
    {
        ...
        compilerOptions.SetOptimizationLevel(getShadercOptLevel(s_settings.optLevel));
        compilerOptions.SetTargetEnvironment(shaderc_target_env_vulkan, s_settings.apiVersion);
    }
...
std::mutex ShaderCompiler::s_settings_mutex = {};
ShaderCompiler::settings_t ShaderCompiler::s_settings = ShaderCompiler::settings_t{
