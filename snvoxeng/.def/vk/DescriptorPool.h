...
// --- v Defaults v ---
static const auto poolSizes = std::vector<VkDescriptorPoolSize>{};
...
SNBCG_THIS(VkDescriptorPoolCreateFlags, VkDescriptorPoolCreateFlags, vkCreateInfo., flags, Flags, SNBCG_POLICY_RETURN_COPY, SNBCG_POLICY_STORE_COPY)
...
// --- v Optional Fields v ---
SNBCG_THIS(
	std::vector<VkDescriptorPoolSize>, VkDescriptorPoolSize, std::span<const VkDescriptorPoolSize>,
	, poolSizes, PoolSizes,
