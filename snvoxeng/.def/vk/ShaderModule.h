...
SNBCG_THIS(
	const ::sn::voxeng::ShaderCompiler::shader_t*, const ::sn::voxeng::ShaderCompiler::shader_t&,
	, pCode, Code,
	SNBCG_POLICY_RETURN_UNPTR, SNBCG_POLICY_STORE_ADDR
)
#undef SNBCG_THIS
...
SNBCG_THIS(VkShaderModuleCreateFlags, VkShaderModuleCreateFlags, vkCreateInfo., flags, Flags, SNBCG_POLICY_RETURN_COPY, SNBCG_POLICY_STORE_COPY)
