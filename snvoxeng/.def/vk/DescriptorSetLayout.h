...
SNBCG_THIS(VkDescriptorSetLayoutCreateFlags, VkDescriptorSetLayoutCreateFlags, vkCreateInfo., flags, Flags, SNBCG_POLICY_RETURN_COPY, SNBCG_POLICY_STORE_COPY)
...
// --- v Required Fields v ---
SNBCG_THIS(
	std::vector<VkDescriptorSetLayoutBinding>, const VkDescriptorSetLayoutBinding&, std::span<const VkDescriptorSetLayoutBinding>,
	, bindings, Bindings,
